...
export class Board {
  ...
  constructor() {
    ...
    // start
    this.board[row._8][col._H].type = SquareType.start;
  ...
  PlaceTilesVertical(start: coord, tiles: Array<Tile>): row {
    ...
    do {
      this.board[currentRow++][start.col].tile = tiles[currentTile++];
  ...
  PlaceTilesHorizontal(start: coord, tiles: Array<Tile>): col {
    ...
    do {
      this.board[start.row][currentCol++].tile = tiles[currentTile++];
  ...
  SetSquareValues(locs: Array<coord>, t: SquareType) {
    locs.forEach(square => {
      this.board[square.row][square.col].type = t;
    });
  }
  ...
  private doubleWord(t: SquareType) {
    ...
    this.board[row._2][col._B].type = t;
    this.board[row._2][col._N].type = t;

    this.board[row._3][col._C].type = t;
    this.board[row._3][col._M].type = t;

    this.board[row._4][col._D].type = t;
    this.board[row._4][col._L].type = t;

    this.board[row._5][col._E].type = t;
    this.board[row._5][col._K].type = t;

    this.board[row._14][col._B].type = t;
    this.board[row._14][col._N].type = t;

    this.board[row._13][col._C].type = t;
    this.board[row._13][col._M].type = t;

    this.board[row._12][col._D].type = t;
    this.board[row._12][col._L].type = t;

    this.board[row._11][col._E].type = t;
    this.board[row._11][col._K].type = t;

  }

  private doubleLetter(t: SquareType) {

    this.board[row._1][col._D].type = t;
    this.board[row._1][col._L].type = t;

    this.board[row._3][col._G].type = t;
    this.board[row._3][col._I].type = t;

    this.board[row._4][col._A].type = t;
    this.board[row._4][col._H].type = t;
    this.board[row._4][col._O].type = t;

    this.board[row._7][col._C].type = t;
    this.board[row._7][col._G].type = t;
    this.board[row._7][col._I].type = t;
    this.board[row._7][col._M].type = t;

    this.board[row._8][col._D].type = t;
    this.board[row._8][col._L].type = t;

    this.board[row._9][col._C].type = t;
    this.board[row._9][col._G].type = t;
    this.board[row._9][col._I].type = t;
    this.board[row._9][col._M].type = t;

    this.board[row._12][col._A].type = t;
    this.board[row._12][col._H].type = t;
    this.board[row._12][col._O].type = t;

    this.board[row._13][col._G].type = t;
    this.board[row._13][col._I].type = t;

    this.board[row._15][col._D].type = t;
    this.board[row._15][col._L].type = t;

  }

  private tripleLetter(t: SquareType) {

    this.board[row._2][col._F].type = t;
    this.board[row._2][col._J].type = t;

    this.board[row._6][col._B].type = t;
    this.board[row._6][col._F].type = t;
    this.board[row._6][col._J].type = t;
    this.board[row._6][col._N].type = t;

    this.board[row._14][col._F].type = t;
    this.board[row._14][col._J].type = t;

    this.board[row._10][col._B].type = t;
    this.board[row._10][col._F].type = t;
    this.board[row._10][col._J].type = t;
    this.board[row._10][col._N].type = t;
